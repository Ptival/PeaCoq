...
let
  ...
  f = { mkDerivation, adjunctions, aeson, array, base, bytestring
      ...
      , network, process, random, snap, snap-core, snap-extras
      , snap-server, stdenv, tagsoup, text, time, transformers
      , unordered-containers, utf8-string, xml-conduit, xml-types
      }:
      mkDerivation {
        pname = "peacoq";
        version = "0.1";
        ...
        executableHaskellDepends = [
          ...
          snap-extras snap-server tagsoup text time transformers
          unordered-containers utf8-string xml-conduit xml-types
        ];
