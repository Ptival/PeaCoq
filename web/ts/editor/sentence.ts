...
export class Sentence<S extends IStage> implements ISentence<S> {
    ...
    constructor(
        ...
        this.commandTag = Maybe.nothing<string>() // filled when Add command is created
        ...
        this.stage$.let(Filters.Stage.beingProcessed)
            .take(1)
        ...
        this.stage$.let(Filters.Stage.processed)
            .take(1)
